          ...
          <div className="p-4 bg-slate-800/30 rounded-xl border border-slate-700/50 space-y-4">
              ...
              {parentSettings?.traktAccessToken ? (
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="text-[10px] font-bold text-rose-400 hover:text-rose-300 bg-rose-500/10 hover:bg-rose-500/20 border border-rose-500/30 px-2 py-0.5 rounded transition-colors"
                  >
                    Disconnect
                  </button>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" placeholder="Enter your Trakt Client ID" className="w-full bg-slate-800/50 border border-slate-700 rounded-xl px-4 py-2.5 text-slate-200 focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-green-500/50 transition-all" value={parentSettings?.traktClientId || ''} onChange={(e) => setParentSettings({ ...parentSettings, traktClientId: e.target.value })} />
              </div>
              <div>
