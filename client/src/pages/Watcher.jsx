  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl font-black tracking-wider text-slate-100">Watchers</h1>
          <p className="text-slate-400 mt-1">Monitor active streams across your media servers.</p>
        </div>
      </div>
